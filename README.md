...
* [* GraalVM 21.1.0-java11](#-graalvm-2110-java11)
      * [Kogito Builder Image usage](#kogito-builder-image-usage)
      * [Kogito Builder Image example](#kogito-builder-image-example)
        * [Builder Image Example with Quarkus](#builder-image-example-with-quarkus)
        * [Builder Image Example with Springboot](#builder-image-example-with-springboot)
